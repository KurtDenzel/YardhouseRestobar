  ...
  <script>
    ...
    <script>
        function resetFields() {
            document.getElementById("field1").value = ""; // Resetting field 1
            document.getElementById("field2").value = ""; // Resetting field 2
            document.getElementById("field3").value = ""; // Resetting field 3
            document.getElementById("field4").value = ""; // Resetting field 4
            document.getElementById("field5").value = ""; // Resetting field 5
            document.getElementById("field6").value = ""; // Resetting field 6
        }
    </script>    
                                ...
                                <div class="col">
                                    <div class="card shadow-lg mb-3">
                                        <div class="card-body">
                                            <!-- Payroll Calculation -->
                                            <form method="get" 
                                            action="PayrollCalculationTest.php?payrollcalid='.$id .'">
                                                ...
                                                if (isset($_GET['submit'])) 
                                                {
                                                    ...
                                                    $NDMinutesPHP = $_GET['NDMinutesPHP'];
                                                    $TotalND = $_GET['TotalND'];

                                                    // Minus to these labels
                                                    $RegHours = $_GET['RegHours'];
                                                    $UnpaidBreaks = $_GET['UnpaidBreaks'];
                                                    
                                                    $HourPHP = $_GET['HourPHP'];
                                                    $DayPHP = $_GET['DayPHP'];
                                                    ...
                                                    $OTReceipt = $OTHours * $OTRate;
                                                    $TotalDurHours = $TotalDurHours;
                                                    $TotalND = $ND;

                                                    // Appending the records into the dbs of tbl_payroll
                                                    $query = "INSERT INTO tbl_payroll
                                                    (Date, EmployeeName, TotalDurationHours , UnpaidBreaks, AdjustedRegHours, OTHours, NDHourPHP, NDMinutesPHP, DayPHP, HourPHP, TotalND, TotalPay) 
                                                    
                                                    VALUES ('$DateToday', '$EmployeeName','$TotalDurationHours', 
                                                        '$UnpaidBreaks', '$AdjRegHours', '$OTHours',
                                                        '$NDHourPHP', '$NDMinutesPHP', '$DayPHP', '$HourPHP',
                                                        '$TotalND', '$TotalPay')";
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xxl-8" style="margin-bottom: 10px;"><input class="form-control form-control" type="text" disabled 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        data-toggle="tooltip" data-placement="top" title="Broad Range to 0 to 1"  
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        data-toggle="tooltip" data-placement="top" title="Fixed Value."  
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        name="OTHours" maxlength="7" size="7" value="<?php echo $OTHours; ?>" 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        data-toggle="tooltip" data-placement="top" title="Night Diffrence Hour"  
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        data-toggle="tooltip" data-placement="top" title="Night Difference Minute(s)"  

                                                        id="field5"

                                                        name="NDMinutesPHP" maxlength="7" size="7" 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    <div class="col-xxl-4">
                                                        <div style="font-size: 20px;"><label class="form-label" for="username" style="color: rgb(0,0,0);font-size: 20px;"><strong>Day PHP:</strong><br></label></div>
                                                    </div>
                                                    <div class="col-xxl-8">
                                                        <div><input class="form-control" type="text"

                                                        data-toggle="tooltip" data-placement="top" title="Minimum Wage"  

                                                        placeholder="570" id="field6"

                                                        name="DayPHP" maxlength="7" size="7" 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    <div class="col-xxl-4">
                                                        <div style="font-size: 20px;"><label class="form-label" for="username" style="color: rgb(0,0,0);font-size: 20px;"><strong>Hour PHP:</strong><br></label></div>
                                                    </div>
                                                    <div class="col-xxl-8">
                                                        <div><input class="form-control" type="text"

                                                        data-toggle="tooltip" data-placement="top" title="DayPHP / 8 = HourPHP"  

                                                        disabled

                                                        name="HourPHP" maxlength="7" size="7" placeholder="71.25" 
                                                        value="<?php echo $HourPHP = $DayPHP / 8; ?>" 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        value="<?php 
                                                            // RegHours
                                                            $RegHours = $TotalDurHours;
                                                            $HourPHP = $DayPHP / 8;

                                                            //Rate
                                                            $OTRate = $HourPHP * 1.25;
                                                            $NDRate = $HourPHP * 0.1;
                                                            $AdjMinute = $NDMinutesPHP / 60; 

                                                            $AdjRegHours = $RegHours - $UnpaidBreaks;
                                                            $REG = $AdjRegHours  * $HourPHP;
                                                            $OT = $OTHours * $OTRate;
                                                                                                                       
                                                            $AdjND = $NDHourPHP + $AdjMinute;
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4 col-xxl-3 offset-xl-4 offset-xxl-6 col-sm-12" style="text-align: center;margin-right: 0px;">
                                                        ...
                                                        value="submit" style="font-size: 20px;width: 200px;background: #00b027;height: 40px;color: rgb(255,255,255);font-weight: bold;margin-right: 30px;">
                                                        Calculate
                                                    ...
                                                    <div class="col-xl-4 col-xxl-3 offset-xxl-0 col-sm-12" style="text-align: center;margin-right: 0px;">
                                                        ...
                                                        style="font-size: 20px;width: 180px;background: #6D6D6D;height: 40px;color: rgb(255,255,255);font-weight: bold;">
