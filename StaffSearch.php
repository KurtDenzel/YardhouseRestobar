...
<?php 
  ...
  if (isset($_POST['search'])) {
    $valueToSearch = $_POST['valueToSearch'];
      ...
      WHERE CONCAT(`name`, `sex`, `emailaddress`, `contactnumber`, 'address', 
  ...
  function filterTable ($query) {
    $con = mysqli_connect("localhost","root","","yardhouse");
...
<head>
    ...
    <title>Admin - Staff Search</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #121212;border-color: var(--bs-dark);color: #121212;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    <li class="nav-item"><a class="nav-link" href="AdminProfile.html"><i class="fas fa-user" style="font-size: 25px;color: #ff9900;"></i><span style="font-size: 20px;">Profile</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="table.html"><i class="fas fa-table" style="font-size: 25px;color: #ff9900;"></i><span style="font-size: 20px;">Payroll</span></a></li>
...
?>
            ...
            <div class="container py-3 d-flex justify-content-start">
              ...
              <?php 
                ...
                $res = mysqli_query($con,"SELECT * FROM tbl_employee ORDER BY id asc");
                ...
                if ($count==0) 
                {
                  ...
                  <div class='container p-5 text-center'>
                    <strong> No Employee Results Found </strong>
                  </div>  
