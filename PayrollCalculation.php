                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow-lg mb-3">
                                        <div class="card-body">
                                            <!-- Payroll Calculation -->
                                            <form method="" action="PayrollCalculationTwo.php">
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        name="RegMinutes" maxlength="7" size="7" 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        name="HourPHP" maxlength="7" size="7" 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        name="Total" maxlength="7" size="7" value="<?php echo $OTHours; ?>" 
                                                ...
                                                <div class="row" style="padding-bottom: 0;height: 45px;margin-top: 10px;margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-xxl-8">
                                                        ...
                                                        echo $TotalPay = $UnpaidBreaks - $TotalDurHours;
                                ...
                                <?php 
                                    ...
                                    if (isset($_GET['submit'])) {
                                        // Disabled Fields; but to be appended on the dbs
                                        $Date = $_GET['Date'];
                                        ...
                                        $AdjRegHours = $_GET['AdjRegHours'];
                                        $NightDiffHours = $_GET['NightDiffHours'];
                                        $DayPHP = $_GET['DayPHP'];
                                        $HourPHP = $_GET['HourPHP'];
                                        $OTHours = $_GET['OTHours'];

                                        // Disabled Fields; but to be appended on the dbs
                                        $RegularRate = $_GET['RegularRate'];
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div class="row" style="height: 40px;">
                                                <div class="col-xxl-6 col-sm-6" style="height: 40px;padding-right: 0px;padding-left: 0px;text-align: left;"><label class="col-form-label" style="font-size: 20px;color: rgb(0,0,0);">Date:</label></div>
                                            </div>
                                            <!-- Date -->
                                            ...
                                            <!-- OT -->
                                            <div class="row" style="height: 40px;">
                                                <div class="col-xxl-6 col-sm-6" style="height: 40px;padding-right: 0px;padding-left: 0px;text-align: left;"><label class="col-form-label" style="font-size: 20px;color: rgb(0,0,0);">OT:</label></div>
                                            </div>
                                            <!-- OT -->

                                            <!-- Calculated Hours -->
                                            <div class="row" style="height: 40px;">
                                                <div class="col-xxl-6 col-sm-6" style="height: 40px;padding-right: 0px;padding-left: 0px;text-align: left;"><label class="col-form-label" style="font-size: 20px;color: rgb(0,0,0);">Calculated Hours:</label></div>
                                            </div>
                                            <!-- Calculated Hours -->

                                            <!-- Total Pay -->
                                            <div class="row" style="height: 40px;">
                                                <div class="col-xxl-6 col-sm-6" style="height: 40px;padding-right: 0px;padding-left: 0px;text-align: left;"><label class="col-form-label" style="font-size: 20px;color: rgb(0,0,0);font-weight: bold;">Total Pay:</label></div>
                                            </div>
                                            <!-- Total Pay -->
                                    ...
                                    <div class="card shadow-lg mb-3">
                                        <div class="card-body">
                                            <div class="mb-4" style="text-align: center;margin-top: 20px;">
                                                <div class="row">
                                                    <div class="col">
                                                        <h3 class="text-dark mb-4" style="color: rgb(0,0,0);margin-left: 20px;font-size: 30px;font-weight: bold;">

                                                            Set Employee Salary Status
