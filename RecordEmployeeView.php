        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: url(&quot;assets/img/bg.png&quot;) center / cover no-repeat, #e2e2e2;">
                ...
                <div class="container-fluid" style="margin-top: 0px;">
                    ...
                    <div style="padding: 20px;text-align: right;"><a class="btn btn-primary" role="button" style="width: 200px;background: #ff9900;" href="CalculatedPayroll.php">Back</a></div>
                </div>
            </div>
        </div>
    </div>
