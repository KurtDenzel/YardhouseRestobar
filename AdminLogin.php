                    ...
                    <div class="card-body p-0" style="height: 600px;background: url(&quot;assets/img/BG-Login.png&quot;) center / cover no-repeat;">
                        <div class="row" style="height: 600px;">
                            ...
                            <div class="col" style="text-align: center;"><img class="img-fluid" src="assets/img/logo.png" style="width: 270px;margin-top: 40px;">
                                <h1 style="color: rgb(255,255,255);font-weight: bold;font-size: 20px;">Hello, Admin!</h1>
                                ...
                                <div><input type="text" placeholder="Username" name="Username" 
                                    ...
                                    title="e.g. AdminIloveyou, AdminCarlo etc."  

                                    required style="width: 250px;margin: 10px;margin-bottom: 5px;border-radius: 5px;"><br>
