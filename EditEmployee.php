        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #121212;border-color: var(--bs-dark);color: #121212;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <div class="text-center d-none d-md-inline"><button class="btn rounded-circle border-0" id="sidebarToggle" type="button"></button>
                    <ul class="navbar-nav text-light" id="accordionSidebar" onclick="return confirm('Are you sure you want to proceed?');">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: url(&quot;assets/img/bg.png&quot;) center / cover no-repeat, #e2e2e2;">
                ...
                <div class="container-fluid" style="margin-top: 5vh;">
                    <h3 class="text-dark mb-4" style="color: rgb(0,0,0);font-weight: bold;margin-left: 20px;font-size: 30px;">Edit / Delete Employee</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col">
                                            ...
                                            <form action="" method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xxl-12">
                                                        <div class="mb-3"><label class="form-label" style="color: rgb(0,0,0);font-size: 20px;"><strong>Name</strong></label><input class="form-control" type="text" 

                                    data-toggle="tooltip" data-placement="top" 
                                    title="e.g. Juan Dela Cruz, Ynnah Dela Cruz etc."                                                            

                                                            value="<?php echo $name ?>"

                                                            placeholder="ex. JUAN" name="name" style="font-size: 20px;"></div>
                                                    </div>
                                                    <!-- Name -->
                                                </div>
                                                <div class="row">
                                                    <!-- Sex -->
                                                    <div class="col-sm">
                                                        <div class="mb-3"><label class="form-label" style="color: rgb(0,0,0);font-size: 20px;"><strong>Sex</strong></label><input class="form-control" type="text"

                                    data-toggle="tooltip" data-placement="top" 
                                    title="Male / Female"                                                        

                                                         value="<?php echo $sex ?>" name="sex" style="font-size: 20px;"></div>
                                                    </div>
                                                    <!-- Sex -->
                                                ...
                                                <div class="row">
                                                    <!-- Email -->
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" style="color: rgb(0,0,0);font-size: 20px;"><strong>Email Address</strong><br></label>
                                                            <input class="form-control" type="text"

                                    data-toggle="tooltip" data-placement="top" 
                                    title="rodriguez@gmail.com"         

                                                            value="<?php echo $email ?>"

                                                            name="email" style="font-size: 20px;"></div>
                                                    </div>

                                                    <!-- Contact Number -->
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"  style="font-size: 20px;color: rgb(0,0,0);"><strong>Contact Number</strong><br></label><input class="form-control" 
                                    ...
                                    title="09872345678"
                                                        ...
                                                        type="text" name="contact" style="font-size: 20px;"></div>
                                                    </div>
                                                    <!-- Contact Number -->
                                                </div>
                                                <div class="row">
                                                    <!-- Address -->
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" style="font-size: 20px;color: rgb(0,0,0);"><strong>Address</strong><br></label><input class="form-control" 
                                    ...
                                    title="Caloocan City"
                                                            ...
                                                            type="text" name="address" style="font-size: 20px;"></div>
                                                    </div>
                                                    <!-- Address -->
                                                </div>
                                                <div class="row">
                                                    <!-- Job -->
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name" style="color: rgb(0,0,0);font-size: 20px;"><strong>Job Designation</strong><br></label><input class="form-control" type="text"
                                    ...
                                    title="Cashier"             
                                                        ...
                                                        value="<?php echo $job ?>"
                                                         ...
                                                         name="job" style="font-size: 20px;"></div>
                                                    </div>
                                                    <!-- Job -->
                                                </div>  
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                    <!-- Username -->
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" style="font-size: 20px;color: rgb(0,0,0);"><strong>Username</strong><br></label><input class="form-control" 

                                    data-toggle="tooltip" data-placement="top" 
                                    title="e.g. Keannu, Carlo etc."

                                                            value="<?php echo $username ?>"

                                                            type="text" name="username" style="font-size: 20px;"></div>
                                                    </div>
                                                    <!-- Username -->
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <!-- Password -->
                                                    <div class="col">
                                                        <div class="mb-3" style="margin-bottom: 0px;"><label class="form-label" style="color: rgb(0,0,0);font-size: 20px;"><strong>Password</strong><br></label><input class="form-control" type="Password" 

                                    data-toggle="tooltip" data-placement="top" 
                                    title="e.g. Iloveyou123"
                                    ...
                                    <div class="mb-4" style="text-align: center;margin-top: 20px;">
                                        <div class="row">
                                            ...
                                            <div class="col" style="text-align: center;margin-bottom: 10px;">
                                                ...
                                                <button class="btn btn-success btn-sm" type="submit" name="update" value="Update Student"
                                                
                                                onclick="return confirm('Are you sure you want to proceed with this action?');" 

                                                 style="font-size: 20px;width: 200px;background: #00b027;height: 40px;color: rgb(255,255,255);font-weight: bold;">
                                                Update</button>
                                            ...
                                            <!-- Cancel -->
                                                <div class="col" style="text-align: center;"><a class="btn btn-sm" role="button" style="font-size: 20px;width: 200px;background: #c7c7c7;height: 40px;color: rgb(0,0,0);font-weight: bold;margin-left:  0px;" href="Staff.php">Cancel</a></div>
                                            <!-- Cancel -->
                                            </form>
                                        </div>
                                    </div>
...
<?php  
  ...
  if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE tbl_employee SET id = $id, 
    name = '$Name', sex = '$Sex',
    ...
    if ($result) {
      ...
      echo 
          "<script type='text/javascript'>
            alert('Employee has not been updated...')
          </script>";    
    }
